...
if (isset($_SESSION["user"]) && isset($_GET["id"]) && isset($_GET["qty"])) {
    ...
    WHERE product.id = '" . $pid . "' AND `status_id` = '1' AND `qty` != 0; ");
...
?>
                            ...
                            <div class="col-12 pt-2" id="Invoicepage">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-sm-6 text-end pt-md-2">
                                        <div class="mt-2">Order ID:<?= $_GET["orderId"] ?></div>
    ...
    ('" . $_GET["orderId"] . "','" . $date . "','" . $_GET["qty"] . "','" . $pid . "','" . $_SESSION["user"]["email"] . "','" . $shipping . "','" . $total . "')");
                                        ?>
