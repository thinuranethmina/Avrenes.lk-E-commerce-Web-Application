        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12 bg-light text-center mb-3">
                    <label class="form-label fs-1 fw-bold text-primary">My orders</label>
                </div>
                ...
                <div class="col-12 mt-1">
                    <div class="row">
                        <div class="col-12" id="loadResults">
                            ...
                            INNER JOIN `product` ON `product`.`id` = `invoice`.`product_id` WHERE `invoice`.`user_email` = '" . $_SESSION["user"]['email'] . "' ");
                            ...
                            ?>
                                <div class="row">
                                    ...
                                    <div class="col-4 bg-body text-end">
                                        <label class="form-label fs-5 fw-bold text-black"><?= $history['price'] ?></label>
                                    </div>
